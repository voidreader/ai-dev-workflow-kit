...
```
cat-popup-null-fix
save-data-balance-adjust
ui-tooltip-fix
memorial-system-hotfix
```
...
```
Docs/Archive/MinorTasks/20260311_cat-popup-null-fix/
```
...
## 5. unity_tasks.md 생성 (조건부)

Unity Editor 에서 **수동 작업이 필요한 경우에만 생성한다.**

파일 위치:

```
Docs/Archive/MinorTasks/YYYYMMDD_scope/unity_tasks.md
```

작성 규칙:

- 매우 상세하게 작성한다
- Unity 6.3 LTS (6000.3.x) 기준으로 설명한다
- Inspector 설정, Prefab 연결, Scene 설정 등을 단계별로 설명한다

---

## 6. CLAUDE.md 업데이트 (조건부)

다음 **갱신 트리거 체크리스트** 중 하나라도 해당하면 CLAUDE.md를 업데이트한다:

- [ ] 새로운 매니저 또는 시스템 클래스 추가
- [ ] UI 계층 구조 변경
- [ ] 새로운 SaveData 클래스 추가
- [ ] 데이터 테이블 신규 등록
- [ ] 코딩 컨벤션 또는 금지 사항 변경
...
- 예: `20260311_cat-popup-null-fix.md`
